...
export const books: Book[] = [
  { id: '1', title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', category: 'Fiction', price: 12.99, stock: 42 },
  { id: '2', title: 'To Kill a Mockingbird', author: 'Harper Lee', category: 'Fiction', price: 14.99, stock: 25 },
  { id: '3', title: '1984', author: 'George Orwell', category: 'Dystopian', price: 10.99, stock: 60 },
  { id: '4', title: 'The Catcher in the Rye', author: 'J.D. Salinger', category: 'Fiction', price: 11.99, stock: 3 },
  { id: '5', title: 'Sapiens: A Brief History of Humankind', author: 'Yuval Noah Harari', category: 'Non-Fiction', price: 18.99, stock: 50 },
  { id: '6', title: 'The Hobbit', author: 'J.R.R. Tolkien', category: 'Fantasy', price: 15.99, stock: 110 },
  { id: '7', title: 'Pride and Prejudice', author: 'Jane Austen', category: 'Romance', price: 9.99, stock: 0 },
  { id: '8', title: 'A Brief History of Time', author: 'Stephen Hawking', category: 'Science', price: 16.99, stock: 20 },
];
...
export const customers: Customer[] = [
  { id: 'CUST01', name: 'Alice Johnson', email: 'alice@example.com', totalOrders: 2, totalSpent: 29.98, joinDate: '2024-01-15' },
  { id: 'CUST02', name: 'Bob Smith', email: 'bob@example.com', totalOrders: 1, totalSpent: 21.98, joinDate: '2024-02-20' },
  { id: 'CUST03', name: 'Charlie Brown', email: 'charlie@example.com', totalOrders: 1, totalSpent: 34.98, joinDate: '2024-03-10' },
  { id: 'CUST04', name: 'Diana Prince', email: 'diana@example.com', totalOrders: 1, totalSpent: 14.99, joinDate: '2024-04-05' },
  { id: 'CUST05', name: 'Eve Adams', email: 'eve@example.com', totalOrders: 1, totalSpent: 0, joinDate: '2024-05-01' },
];
