...
export function BannerForm({ bannerId, onSaveSuccess, onCancel }: BannerFormProps) {
  ...
  const handleSelectChange = (value: string) => {
    ...
    setFormData(prev => ({ ...prev, bookId, callToAction: bookId ? `/store/book/${bookId}` : '' }));
                         ...
                         <div className="sm:col-span-2">
                            <Label htmlFor="callToAction">Call to Action URL</Label>
                             <div className="relative mt-1">
                                ...
                                <Input id="callToAction" name="callToAction" placeholder="/store/book/book-id" value={formData.callToAction} onChange={handleChange} className="pl-9" />
                            </div>
                        </div>
                        <div className="sm:col-span-2">
